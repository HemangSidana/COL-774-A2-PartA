...
if __name__ == '__main__':
    ...
    GT_weights_file = "Part_a_b_checker_script/Multi_xavier_updated_part_1_b/ep_5.pkl" #Add path to the given weights.pkl here for a particular epoch to be used for comparison.
